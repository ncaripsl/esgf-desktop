...
*/
Ext.define('MyDesktop.rssfeeds.views.FeedGrid', {
    extend: 'Ext.grid.Panel',
    
    requires: ['MyDesktop.rssfeeds.stores.FeedStore'],
...
//    },
    ...
    formatTitle: function(value, p, record){
        return Ext.String.format('<div class="topic"><b>{0}</b><span class="author">{1}</span></div>', value, record.get('author') || "Author Undefined");
    },
